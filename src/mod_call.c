...
//svp;
  ...
  {GSF_ID_MQTT_WEBRTC_CFG,   "GSF_ID_MQTT_WEBRTC_CFG",  GSF_IPC_MQTT_WEBRTC,(sjb_cb*)sjb_bind_gsf_mqtt_webrtc_cfg_t,  (sjb_cb*)sjb_bind_gsf_mqtt_webrtc_cfg_t,sizeof(gsf_mqtt_webrtc_cfg_t), sizeof(gsf_mqtt_webrtc_cfg_t),0},
